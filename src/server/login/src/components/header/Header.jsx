...
export default function Header(
    ...
    useEffect(() => {
        if (children) observeNavWidth(contentRef.current, headerSize, setHeaderSize);
                ...
                { 
                    pageName ? 
                        <a 
                            ...
                            style={
                                { 
                                    color: pageScrolled ? textColorOnScroll : pageNameColor 
                                }
                            } 
                            href={pageNameHref} 
                            onClick={()=>goTop()}
                ...
                { 
                    children && topHeight > 0 ? 
                        <Nav 
                            ...
                            color={ pageScrolled ? textColorOnScroll : navColor } 
                            barsColor={ pageScrolled ? textColorOnScroll : navColor }
                        >
                            {children}
                        </Nav> 
                    : <></> 
...
function isTransparent (color, umbral=1) {
    if (isColor(color)) {
