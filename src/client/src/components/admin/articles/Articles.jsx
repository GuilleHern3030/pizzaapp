...
import { createArticle } from "../../../redux/reducers/articles/article";
...
export default function Articles() {
    const categories = useSelector(getArticlesByCategory())
    ...
    const saveArticles = async() => {
        if (saveDataEnabled) {
            ...
            if (success === true) setSaveDataText("Saved successfully")
    ...
    const handleSubmit = e => {
        if (changes) {
            ...
            || name.length == 0) {
                ...
                return onSubmit(parseObject(), article)
            }
